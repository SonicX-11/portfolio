        ...
        >
          ...
          >
            <motion.span
              ...
              className="flex h-20 w-20 items-center justify-center rounded-full border border-white/30 bg-white/10 text-3xl text-white backdrop-blur-sm"
            >
          ...
          <button
            ...
            className="absolute bottom-5 right-5 flex h-11 w-11 items-center justify-center rounded-full border border-white/20 bg-bg/60 text-lg text-white opacity-0 backdrop-blur-sm transition-opacity duration-300 group-hover:opacity-100"
          >
